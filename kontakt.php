  ...
  <section  class="seite" id="hero">
    <!-- Flex Container -->
    <div class="container flex flex-col items-start px-6 mx-auto mt-10 space-y-0 md:space-y-0 md:flex-row">
      <!-- Left item -->
      ...
      <form  action="action_page.php" method="POST" id="contact-stack-form" class="form ">
        ...
        <div class="cube-33 w-300 cube">
          <div class="front">
            <button id="contact-stack-button" type="submit" class="button">Submit</button>
          </div>
          <div class="back"></div>
          <div class="top"></div>
          <div class="bottom"></div>
